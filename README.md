...
Formatação automática de valores com Intl.NumberFormat
Troca dinâmica de ícone e nome da moeda ao selecionar
...
Intl.NumberFormat API — Formatação de moedas por localidade


## Links:
- Projeto:https://momade-ibraimo.github.io/Conversor-de-Moedas/
